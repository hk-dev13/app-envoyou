...
const DeveloperDashboard = () => {
        ...
        <div className="relative overflow-hidden rounded-xl border border-border bg-gradient-to-b from-background to-muted/30">
          ...
          <div className="relative p-6 md:p-8 flex flex-col md:flex-row md:items-center md:justify-between gap-6">
            <div className="max-w-2xl">
              <h1 className="text-2xl md:text-3xl font-bold tracking-tight text-primary-foreground">Welcome back, {user?.name || 'Developer'} 👋</h1>
              ...
              <div className="mt-4 flex gap-2">
                ...
                <Link to="/developer/api-docs" className="inline-flex items-center px-4 py-2 rounded-md border border-border text-primary-foreground hover:bg-accent">Read Docs</Link>
              </div>
            </div>
            <div className="flex gap-3">
              <div className="px-4 py-3 rounded-lg bg-card border border-border text-left">
                ...
                <div className="text-xl font-semibold text-primary-foreground">{loading ? '—' : stats.totalRequests.toLocaleString()}</div>
              </div>
              <div className="px-4 py-3 rounded-lg bg-card border border-border text-left">
                <div className="text-xs text-muted-foreground">Active keys</div>
                <div className="text-xl font-semibold text-primary-foreground">{loading ? '—' : stats.activeKeys}</div>
              </div>
            </div>
          </div>
        </div>
  ...
  {/* Recent Activity & Analytics Preview */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            ...
            <CardContent>
              {loading || stats.totalRequests > 0 ? (
                <div className="space-y-4">
                  <div className="flex items-center space-x-3">
                    ...
                    <div className="flex-1">
                      <p className="text-primary-foreground text-sm">API key generated</p>
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div className="flex-1">
                      <p className="text-primary-foreground text-sm">1000 requests processed</p>
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div className="flex-1">
                      <p className="text-primary-foreground text-sm">Rate limit warning</p>
                ...
                <EmptyState
                  ...
                  secondaryAction={<a href="/developer/api-docs" className="inline-flex items-center px-3 py-2 rounded-md border border-border text-primary-foreground hover:bg-accent text-sm">Read Docs</a>}
                />
              )}
            </CardContent>
          </Card>
          ...
          <Card className="bg-card border-border">
            <CardHeader>
              <CardTitle className="text-primary-foreground">Usage Overview</CardTitle>
              <CardDescription>
            ...
            <CardContent>
              <div className="space-y-4">
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-primary-foreground font-medium">15,420 / 50,000</span>
                </div>
                ...
                <div className="flex justify-between items-center">
                  ...
                  <span className="text-primary-foreground font-medium">245 / 1,000</span>
                </div>
                <div className="w-full bg-muted rounded-full h-2">
