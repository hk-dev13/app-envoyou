      ...
      <div className="bg-slate-800 border border-slate-700 rounded-lg p-6">
        ...
        <div className="text-slate-300 mb-6">
          ...
          <a
            ...
            className="inline-block bg-blue-500 hover:bg-blue-600 transition-colors text-white font-medium px-5 py-2 rounded"
          >
        ...
        <div className="bg-slate-900 border border-slate-600 rounded-lg p-4">
          <h2 className="text-xl font-semibold text-white mb-4">Why Redirect?</h2>
