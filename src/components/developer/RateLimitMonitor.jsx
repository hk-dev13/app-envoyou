  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        ...
        <p className="text-slate-400 mt-1">Monitor your API usage and rate limit status</p>
      </div>

      {/* Current Plan */}
      <div className="bg-slate-800/50 border border-slate-700 rounded-lg p-6">
        <h3 className="text-lg font-medium text-white mb-4">Current Plan: Developer</h3>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          <div className="text-center">
            <div className="text-2xl font-bold text-emerald-400">1,000</div>
            <div className="text-sm text-slate-400">Requests/minute</div>
          </div>
          <div className="text-center">
          ...
          <div className="text-center">
            ...
            <div className="text-sm text-slate-400">Requests/day</div>
          </div>
        </div>
      </div>
      ...
      <div className="space-y-4">
        ...
        <div className="bg-slate-800/50 border border-slate-700 rounded-lg p-6">
          <div className="flex justify-between items-center mb-3">
            <h4 className="text-white font-medium">Requests per Minute</h4>
        ...
        <div className="bg-slate-800/50 border border-slate-700 rounded-lg p-6">
          <div className="flex justify-between items-center mb-3">
            <h4 className="text-white font-medium">Requests per Hour</h4>
        ...
        <div className="bg-slate-800/50 border border-slate-700 rounded-lg p-6">
          <div className="flex justify-between items-center mb-3">
            <h4 className="text-white font-medium">Requests per Day</h4>
      ...
      {/* Rate Limit Headers */}
      <div className="bg-slate-800/50 border border-slate-700 rounded-lg p-6">
        <h3 className="text-lg font-medium text-white mb-4">Rate Limit Headers</h3>
      ...
      <div className="bg-gradient-to-r from-emerald-600/20 to-blue-600/20 border border-emerald-500/30 rounded-lg p-6">
        <div className="flex items-center justify-between">
          <div>
            <h3 className="text-lg font-medium text-white">Need Higher Limits?</h3>
            <p className="text-slate-400 text-sm mt-1">Upgrade to Pro plan for 10x higher rate limits</p>
          </div>
